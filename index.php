...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <?php
      ...
      echo "<a href='Frontend_Models/login.php' class='w3-bar-item w3-button w3-hide-small w3-hover-white w3-right'><i class='fa fa-sign-in' aria-hidden='true'></i> Login / Signup</a>";
    }
    ?>
	<!-- >
