...
<div class="w3-card w3-white">
  ...
  if(isset($_SESSION['type'])){
    switch ($_SESSION['type']) {
      case 'user':
        echo "<li class='w3-theme-l5 w3-padding-24'>";
        echo"<a href='Frontend_Models/index.php'<button class='w3-button w3-teal w3-padding-large'><i class='fa fa-check'></i> Add to cart</button>";
        echo"</li>";
        /* if(item is in cart){
              echo "<li class='w3-theme-l5 w3-padding-24'>
                    <a href='Frontend_Models/index.php'<button class='w3-button w3-teal w3-padding-large'><i class='fa fa-check'></i> Remove from cart.</button>
                    </li>";
              echo "<li class='w3-theme-l5 w3-padding-24'>
                    <a href='Frontend_Models/index.php'<button class='w3-button w3-teal w3-padding-large'><i class='fa fa-check'></i> Edit Quantity.</button>
                    </li>";
          }*/
      ...
      case 'admin':
        echo "<li class='w3-theme-l5 w3-padding-24'>";
        echo"<button class='w3-button w3-teal w3-padding-large'><i class='fa fa-check'></i> Remove Item</button>";
        echo"</li>";
        break;
    }
  }
  else{
    echo "Login in order to add to cart.";
  }
  ?>
  </div>
  </div>
