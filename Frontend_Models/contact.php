  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-section">
        <label>Name</label>
        <input class="w3-input" style="width: 235px;" type="text" name="Name" required>
      </div>
      <div class="w3-section">
        <label>Email</label>
        <input class="w3-input" style="width: 235px;" type="text" name="Email" required>
      </div>
      <div class="w3-section">
        <label>Message</label>
        <input class="w3-input" style="width: 235px;" type="text" name="Message" required>
      </div>
